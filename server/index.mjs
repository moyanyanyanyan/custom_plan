...
async function handle(req, res) {
  ...
  try {
    ...
    const result = await stepfun('images/generations', { model: 'step-image-edit-2', prompt: `荒诞发明卡牌方形插画，主题「${body.name}」（${body.description}），深蓝实验室背景，神秘发明装置居中，蒸汽朋克和霓虹线条风格，不得出现文字。`, n: 1, size: '1024x1024', response_format: 'b64_json' });
