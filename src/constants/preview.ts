...
export const experiments: Experiment[] = [
  ...
  { id: 'plant', name: '给绿萝浇水', icon: 'drop', minutes: 5, completed: false },
  { id: 'words', name: '背二十个单词', icon: 'book', minutes: 10, completed: false },
  { id: 'read', name: '阅读 20 分钟', icon: 'clock', minutes: 20, completed: false },
];
