...
export function DesktopDownloadCard() {
  return <section className="desktop-download-card" aria-labelledby="desktop-download-title">
    ...
    <details><summary>安全与校验说明</summary><div>本版本由个人开发者构建，尚未购买代码签名证书，因此 Windows 可能显示“未知发布者”或 SmartScreen 提示。这不是安装包被判定为恶意软件的结论，而是未签名程序的常见提示。请确认文件来自本项目 Release，并核对 SHA-256。项目不在安装包中植入广告、捆绑软件或额外安装器；如需进一步验证，可使用 Windows Defender 或其他安全软件扫描。<code>{DESKTOP_DOWNLOAD.sha256}</code></div></details>
  </section>;
}
